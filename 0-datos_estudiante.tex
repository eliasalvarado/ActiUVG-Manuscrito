...
% -------------------------------------------------------------------------------
% Nombre completo
\def \nombreestudiante {Elías Alberto Alvarado Raxón}
% Carné
\def \uvgcarne {21808}
% Facultad
...
% -------------------------------------------------------------------------------
% Título completo
\def \titulotesis {Plataforma Web para la Gestión y Promoción de Proyectos de Extensión mediante un Sistema Centralizado}
% Año de entrega
\def \anoentrega {2026}
% Asesor
\def \nombreasesor {M. Ed. Dennis Aldana}

% Datos del tribunal examinador:
% -------------------------------------------------------------------------------
% Nombre del primer examinador
\def \nombreprimerex {PENDIENTE}
% Nombre del segundo examinador
\def \nombresegundoex {PENDIENTE}
% Año de aprobación
\def \anoaprobacion {PENDIENTE}
