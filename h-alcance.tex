...
Como entregable del \textit{Backend} se tendrá una API con un conjunto de \textit{enpoints}
...
previamente contruidos y validados. Esta intefaz deberá de permitir a los usuarios finales
...
\begin{itemize}
    ...
    \item Pruebas unitarias, de estrés, de concurrencia y de rendimiento y análisis de vulnerabilidades para la API.
    \item Pruebas de tiempo de carga, rendimiento y análisis de vulnerabilidades para el \textit{Frontend}.
