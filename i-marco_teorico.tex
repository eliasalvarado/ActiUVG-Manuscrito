...
El Sistema de Escalas de Usabilidad (SUS, por sus siglas en inglés) es un pequeño cuestionario que busca evaluar la usabilidad de
cualquier sistema. Permite evaluar tres parámetros principales: eficacia, eficiencia y satisfacción. Consta de 10 preguntas predefinidas
con respuestas en una escala de 5 puntos, donde 1 es "totalmente en desacuerdo" y 5 es "totalmente de acuerdo". El puntaje final se 
calcula de la siguiente manera \cite{castro2016herramienta}:
\begin{enumerate}
