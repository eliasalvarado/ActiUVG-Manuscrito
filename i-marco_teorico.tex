...
OWAS \textit{Zed Attack Proxy} (ZAP, por sus siglas en inglés) es una herramienta de código abierto para encontrar vulenrabilidades en
...
incorrectas, entre otros. Esto debido a sus herramientas de rastreo \textit{Spider}, el cual analiza el contenido HTML estático con el objetivo
