...
El término \textit{\gls{frontend}}, de la mano con el componente \textit{Vista}, hace referencia a la interfaz gráfica de usuario
...
El término \textit{\gls{backend}}, de la mano con el componente \textit{Controlador} y el componente \textit{Modelo}, es el
