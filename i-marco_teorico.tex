...
\section{Transformación Digital en la Educación Superior}
    ...
    Una aplicación Web es un programa informático o software el cuál se ejecuta en Internet, sin la necesidad de que 
...
S3 es un servicio de Amazon para almacenamiento de objetos basado en la nube. Proporciona disponibilidad, seguridad y alta escalabiliad.
...
gracias a su enfoque de almacenamiento compartido mediante almacenamiento centralizado y enlaces simbólicos, el cuál permite 
