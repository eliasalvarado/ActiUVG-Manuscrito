...
Bajo este sentido, \textit{ActiUVG} busca demostrar la viabilidad de una plataforma web para la gestión de proyectos de
extensión universitaria dentro de la Universidad del Valle de Guatemala a través de una transformación digital que
permita a los actores involucrados en los proyectos de extensión universitaria realizar sus actividades a través de un
solo canal. De manera que puedan encontrar una herramienta capaz de centralizar la administración, publicación, participación
y seguimiento de los proyectos de extensión de la UVG alcanzable desde cualquier dispositivo con acceso a Internet, gracias
a la elección de tecnologías web modernas y escalables.
