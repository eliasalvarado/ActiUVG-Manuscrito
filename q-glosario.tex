...
{
    name=Responsive,
    description={Característica de una interfaz de usuario que se adapta dinámicamente al tamaño de pantalla del dispositivo en el que se visualiza, garantizando una experiencia de usuario óptima en todos los dispositivos.}
}